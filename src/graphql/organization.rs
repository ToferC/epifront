...
pub fn get_organization_by_id(id: UUID, bearer: String) -> Result<organization_by_id::ResponseData, Box<dyn Error>> {
...
pub fn all_organizations(bearer: String) -> Result<all_organizations::ResponseData, Box<dyn Error>> {
